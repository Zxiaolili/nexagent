...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    "chat.history": "历史对话",
    "chat.newChat": "新对话",
    "chat.placeholder": "描述需求，输入 @ 引用页面或元素…",
    "chat.mentionHeading": "引用",
    "chat.mentionPages": "页面",
    "chat.mentionElements": "元素",
    "chat.mentionKindPage": "页",
    "chat.mentionKindElement": "元素",
    "chat.mentionNoPages": "暂无页面，请先让 Agent 创建页面",
    "chat.mentionEmpty": "没有匹配项",
    ...
    "tool.listingFlows": "列出流程关系",
    "tool.removingFlow": "删除流程关系",
    "tool.args": "入参",
    "tool.result": "返回",
    "tool.replaceBefore": "替换前",
    "tool.replaceAfter": "替换后",
    "tool.bodyPreview": "正文节选",
    "tool.streamingArgs": "参数（流式）",
    "tool.executing": "执行中…",
    ...
    "workspace.closeAgent": "关闭 Agent 面板",
    "workspace.resizeColumns": "拖拽调整面板宽度",
    "workspace.resizeSidebarSections": "拖拽调整对话区与文件区高度",
    "preview.displayScale": "画面大小",
  ...
  en: {
    ...
    "chat.placeholder": "Describe your prototype. Type @ to reference a page or element…",
    "chat.mentionHeading": "Reference",
    "chat.mentionPages": "Pages",
    "chat.mentionElements": "Elements",
    "chat.mentionKindPage": "Page",
    "chat.mentionKindElement": "El",
    "chat.mentionNoPages": "No pages yet — ask the agent to create one",
    ...
    "tool.listingFlows": "Listing flows",
    "tool.removingFlow": "Removing flow",
    "tool.args": "Arguments",
    "tool.result": "Result",
    "tool.replaceBefore": "Before",
    "tool.replaceAfter": "After",
    "tool.bodyPreview": "Body preview",
    "tool.streamingArgs": "Arguments (streaming)",
    ...
    "workspace.closeAgent": "Close agent panel",
    "workspace.resizeColumns": "Drag to resize panel width",
    "workspace.resizeSidebarSections": "Drag to resize conversations and files height",
    "preview.displayScale": "Display scale",
